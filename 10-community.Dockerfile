...
ADD --chown=sonarqube:sonarqube https://github.com/vaulttec/sonar-auth-oidc/releases/download/v${OIDC_PLUGIN_VERSION}/sonar-auth-oidc-plugin-${OIDC_PLUGIN_VERSION}.jar
